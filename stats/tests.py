...
class StatsApiTests(TestCase):
    ...
    def test_number_of_viewers(self):
        ...
        p1 = Person.objects.create(device=d1,
            appears=parse_datetime('2016-01-01 00:00:38'),
            disappears=parse_datetime('2016-01-01 00:01:06'),
            age=40, gender='female')
        p2 = Person.objects.create(device=d1,
            appears=parse_datetime('2016-01-01 00:01:04'),
            disappears=parse_datetime('2016-01-01 00:01:27'),
        ...
        # Four events of showing the diffrent content on different devices
        # same time
        ...
        # Result of GET to /viewer-count/?start='2016-01-01 00:00:01'& \
        # end='2016-01-01 00:01:29'&device=1&content=1 should be
        # {"start": "2016-01-01 00:00:01", "end": "2016-01-01 00:01:29",
        # "device_id": 1, "content_id": 1 "views": 2}
        url = reverse('stats-app:viewer-count')
        response = self.client.get(url, {'start': '2016-01-01 00:00:01',
            'end': '2016-01-01 00:01:29', 'device': 1, 'content': 1})

        self.assertEqual(response.status_code, 200)
        data = json.loads(response.content)
        self.assertEqual(data['start'], '2016-01-01 00:00:01')
        self.assertEqual(data['end'], '2016-01-01 00:01:29')
